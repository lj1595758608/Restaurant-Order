...
<script type="text/javascript">
	...
	function showList(responseXml, obj) {
		...
		for ( var i = 0; i < users.length; i++) {
			...
			newLine += "class='icon-cogs icon-large' title='修改员工信息' onclick='window.location=\"tomodifyuser.order?userId=" + userId + "\"'></i>&nbsp;&nbsp;";
			...
			newLine += "onmouseover='this.style.color=\"orange\"'";
			newLine += "onmouseout='this.style.color=\"black\"'";
			newLine += "class='icon-remove-sign icon-large' title='删除该员工' onclick='deleteUser(" + userId + ",\"" + userAccount + "\",this)'></i>";
