...
<head>
    ...
    <script href="bootstrap/js/bootstrap-datetimepicker.min.js"></script>
    <script href="bootstrap/js/bootstrap-datetimepicker.zh-CN.js"></script>
    <style type="text/css">
        .modal-backdrop{
            position: fixed;
            top: 0;
    ...
    <script type="text/javascript" >
        function getOrderList(stattime, endtime) {
        ...
        function showList(responseXml, obj) {
            ...
            for (var i = 0; i < orders.length; i++) {
                ...
                var newLine = "<tr><td>" + tableId + "</td><td>" + orderEndDate + "</td><td>" + waiterId + "</td><td>" + totalPrice +"</td>";
                ...
                newLine += "class='icon-sitemap icon-large' title='查看经营数据' onclick='detail(\""+tableId+"\",\""+orderBeginDate+"\",\""+orderEndDate+"\",\""+waiterId+"\",\""+totalPrice+"\",\""+ orderId +"\")'></i>&nbsp;&nbsp;";
                newLine += "</td></tr>";
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="tomodifymypass.order?userId=${USER_INFO.userId}">修改我的密码</a></li>
            ...
            <ol class="breadcrumb">
                ...
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title">搜索特定时间订单</h3>
                    </div><br>
                    <div class="container-fluid">
                        <div class="form-inline">
                            <div class="form-group input-append date" id="datetimepicker">
                                <label for="starttime">&nbsp;开始时间：</label>
                                <input name="starttime" class="form-control" type="datetime-local" id="starttime">
                            ...
                            <button class="btn btn-danger" onclick="getOrderList(document.getElementById('starttime').value,document.getElementById('endtime').value)">开始搜索</button>
...
<%--SELECT dishesName,dishesPrice,num FROM dishesinfo,orderdishes WHERE orderdishes.`dishes`=dishesinfo.`dishesId` AND orderReference=4--%>
<!-- Modal -->
