    ...
    <script type="text/javascript">
        ...
        function deleteDishes(id, name, obj) {
            ...
            if (confirm("您真的要删除菜品【" + name + "】吗？")) {
                xmlAjaxRequest("deletedishes.order?dishesId=" + id + "&time=" + Math.random(), "get", true, null, deleteCallback, obj, null);
        ...
        function showList(responseXml, obj) {
            ...
            for ( var i = 0; i < dishes.length; i++) {
                ...
                var newLine = "<tr><td>" + dishesId + "</td><td>" + dishesName
                    + "</td><td>" + dishesDiscript + "</td><td>" + dishesPrice + "</td><td>" + recommend + "</td>";
                newLine += "<td>";
                ...
                newLine += "class='icon-cogs icon-large' title='修改菜品信息' onclick='window.location=\"tomodifydishes.order?dishesId=" + dishesId + "\"'></i>&nbsp;&nbsp;";

                newLine += "<i style='cursor: pointer; font-size: 14;'";
                newLine += "onmouseover='this.style.color=\"orange\"'";
                newLine += "onmouseout='this.style.color=\"black\"'";
                newLine += "class='icon-sitemap icon-large' title='查看菜品详情' onclick='detail(\""+dishesName+"\",\""+dishesDiscript+"\",\""+dishesPrice+"\",\""+dishesImg+"\")'></i>&nbsp;&nbsp;";

                newLine += "<i style='cursor: pointer; font-size: 14;'";
                newLine += "onmouseover='this.style.color=\"orange\"'";
                newLine += "onmouseout='this.style.color=\"black\"'";
                newLine += "class='icon-remove-sign icon-large' title='删除该菜品' onclick='deleteDishes(" + dishesId + ",\"" + dishesName + "\",this)'></i>";
        ...
        function detail(name, discript, price,img) {
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" style="z-index: 2000">
            ...
            <div class="modal-body"
                ...
                <div class="panel panel-danger" style="margin-top: 10px">
                    ...
                    <div class="panel-body" style="text-align: center;">
                        ...
                        <img src="img/dishes/1.jpg" id="dishesImg" width="200px"
                             height="200px" class="img-circle"
                             style="border:1px solid #CCC;box-shadow:0 0 10px rgba(100, 100, 100, 1);" />
                        <p><h2>菜品名称：

                        <span id="dishesName"></span>
                    </h2>
                        </p>
                        <p><h3>
                        菜品简介：<span id="dishesDiscript"></span></h3>
                        </p>
                        <p><h3>
                        菜品价格：<span id="dishesPrice"></span></h3>
                        </p>
