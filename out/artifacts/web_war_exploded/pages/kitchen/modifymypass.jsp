...
<head>
    ...
    <script type="text/javascript">
        ...
        function checkOldPassword() {
            ...
            if (oldPass.value != ""){
                txtAjaxRequest("checkuserpass.order?userAccount=${MODIFY_INFO.userAccount}&oldPass=" + encodeURIComponent(oldPass.value)
                    + "&time=" + Math.random(), "post", true, null, userCallback,
                    null, null);
            }
        }
...
<div class="jumbotron"
    ...
    <div class="container">
        ...
        <p>
            亲爱的<span style="color: red;font-weight: bold;">【${MODIFY_INFO.userAccount}】</span>，
            ${ORDER_SYS_NAME}提示：您可以在本界面修改您的账户密码及头像信息！
        </p>
    ...
    <div class="row" style="padding-top: 0px">
        <div style="width: 50%;display: inline-block;">
            <div>
                ...
                <h2>您可以在此修改您的账户信息：</h2>
                <p>请在下面的界面中修改您的密码（需要提供现密码用于认证），您的账号名及身份角色信息由餐厅管理员指定后，不能修改</p>
                ...
                <form class="form-horizontal" role="form" style="margin-top: 20px"
                      method="post" action="modifymyinfoforkitchen.order">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="firstname"
                                   name="userAccount"  disabled="disabled"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="userPass1"
                                   name="userPass1" onblur="checkpass()" maxlength="10">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="roleId" id="roleId" disabled="disabled">
                                <option value="1"
                        ...
                        <div style="color: red;float: right;">您的角色信息由系统管理员指定后，不能修改</div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <input type="submit" class="btn btn-danger"
                                   disabled="disabled" id="addbtu" value="确认修改" />
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div style="text-align: center;">
                ...
                <div>
                    ...
                    <form class="form-inline" role="form"
                          enctype="multipart/form-data" action="upimg.order?location=faces" name="imgform"
