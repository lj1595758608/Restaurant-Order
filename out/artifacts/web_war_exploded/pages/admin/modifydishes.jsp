...
<head>
    ...
    <script type="text/javascript">
        function beginCheck() {
            var check = ${MODIFY_INFO.recommend};
            if(check == "1"){
...
<body style="font-family: 微软雅黑" onload="beginCheck()">
...
<div class="container">
    <div class="row">
        ...
        <div style="width: 60%;display: inline-block;margin-top: 15px" >
            ...
            <div>
                ...
                <p>
                <form class="form-horizontal" role="form" style="margin-top: 20px" method="post" action="adminmodifydishes.order?dishesId=${MODIFY_INFO.dishesId}">
                    <div class="form-group">
                        <label for="firstname" class="col-sm-2 control-label" >名&nbsp;&nbsp;&nbsp;&nbsp;称:</label>
                        <div class="col-sm-10" >
                            <input type="text" class="form-control" id="firstname"
                                   name="dishesName" value="${MODIFY_INFO.dishesName}" maxlength="20">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="dishesDiscript"
                                   name="dishesDiscript" value="${MODIFY_INFO.dishesDiscript}" maxlength="200">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="dishesTxt" id="dishesTxt" cols="30" rows="10" style="margin-bottom: 15px" maxlength="400">${MODIFY_INFO.dishesTxt}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="dishesPrice"
                                   name="dishesPrice" value="${MODIFY_INFO.dishesPrice}"
        ...
        <div style="width: 5%;display: inline-block;padding-top: 0px;margin-top: 0px;vertical-align: top;padding-left: 20px">
            <div style="background-color:#CCC; width:1px;height: 700px;margin-top: 0px"></div>
        </div>
        <div style="width: 30%;display: inline-block;vertical-align: top; margin-top: 55px">
            <h2>设置图片：</h2>
            <p style="margin-bottom: 10px">菜品图片上传成功后将在下面直接预览。</p>
            <div style="text-align: center;">
                <img src="img/dishes/${MODIFY_INFO.dishesImg}" id="dishes" width="200px"
